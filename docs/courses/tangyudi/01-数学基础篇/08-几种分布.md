...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布1.png)

![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布2.png)

![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布3.png)
...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布4.png)
...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布5.png)
...
- PDF ( 概率密度函数 ): 是对 连续性随机变量 的定义. 与PMF不同的是 PDF 在特定点上的值并不是该点的概率, 连续随机概率事件只能求一段区域内发生事件的概率, 通过对这段区间进行积分来求. 通俗来说, 使用这个概率密度函数 将 想要求概率的区间的临界点( 最大值和最小值)带入求积分. 就是该区间的概率.
  ...
  ![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布6.png)

  ![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布7.png)
...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布8.png)

![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布9.png)
...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布10.png)
...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布11.png)

![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布12.png)
...
![](https://cdn.staticaly.com/gh/clint-sfy/blogcdn@master/python/math/分布13.png)
