import{_ as t}from"./chunks/ArticleMetadata.e10718d6.js";import{_ as c,v as l,b as r,E as y,O as i,F as p,L as A,R as D,M as C,C as B,B as d}from"./chunks/framework.2aeb816e.js";import"./chunks/md5.772bbdf1.js";const v=JSON.parse('{"title":"项目式视图组（基于模型）","description":"","frontmatter":{"title":"项目式视图组（基于模型）","author":"阿源","date":"2023/08/07 12:00","categories":["QT快速入门"],"tags":["C++","QT5"]},"headers":[],"relativePath":"courses/yuanzi/03-QT应用开发和部署/07-项目式视图组（基于模型）.md","filePath":"courses/yuanzi/03-QT应用开发和部署/07-项目式视图组（基于模型）.md","lastUpdated":1691327334000}'),F={name:"courses/yuanzi/03-QT应用开发和部署/07-项目式视图组（基于模型）.md"},E=p("h1",{id:"正点原子qt之项目式视图组-基于模型",tabindex:"-1"},[A("正点原子QT之项目式视图组（基于模型） "),p("a",{class:"header-anchor",href:"#正点原子qt之项目式视图组-基于模型","aria-label":'Permalink to "正点原子QT之项目式视图组（基于模型）"'},"​")],-1),u=D(`<h2 id="_9-项目式视图组-基于模型" tabindex="-1">9. 项目式视图组（基于模型） <a class="header-anchor" href="#_9-项目式视图组-基于模型" aria-label="Permalink to &quot;9. 项目式视图组（基于模型）&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">（1） List View:清单视图</span></span>
