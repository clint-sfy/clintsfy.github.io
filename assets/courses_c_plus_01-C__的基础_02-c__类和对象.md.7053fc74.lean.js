...
<span class="line"><span style="color:#005CC5;">32</span><span style="color:#24292E;"> }</span></span></code></pre></div><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB1.png" alt=""></p><h2 id="_2-实现一个类" tabindex="-1">2. 实现一个类 <a class="header-anchor" href="#_2-实现一个类" aria-label="Permalink to &quot;2. 实现一个类&quot;">​</a></h2><h3 id="请设计一个person类" tabindex="-1">请设计一个Person类 <a class="header-anchor" href="#请设计一个person类" aria-label="Permalink to &quot;请设计一个Person类&quot;">​</a></h3><p>请设计一个Person类，Person类具有name和age属性，提供初始化函数(Init)，并提供对name和age的读写函数(set，get)，但必须确保age的赋值在有效范围内(0-100),超出有效范围，则拒绝赋值，并提供方法输出姓名和年龄</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">#include</span><span style="color:#96D0FF;">&lt;string.h&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">    </span><span style="color:#6F42C1;">test05</span><span style="color:#24292E;">();</span></span>
<span class="line"><span style="color:#24292E;">    </span><span style="color:#D73A49;">return</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">0</span><span style="color:#24292E;">;</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><p>设计一个类：无参构造、有参构造、析够函数、拷贝构造</p><h2 id="_9-初始化列表" tabindex="-1">9. 初始化列表 <a class="header-anchor" href="#_9-初始化列表" aria-label="Permalink to &quot;9. 初始化列表&quot;">​</a></h2><p>一个类的对象 作为另一个类的成员：成员对象</p><p>如果类中想调用成员对象的有参构造 必须使用初始化列表。</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB5.png" alt=""></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">A成员对象 B自身</span></span>
...
<span class="line"><span style="color:#005CC5;">8</span><span style="color:#24292E;"> }</span></span></code></pre></div><h3 id="_2、静态成员数据" tabindex="-1">2、静态成员数据 <a class="header-anchor" href="#_2、静态成员数据" aria-label="Permalink to &quot;2、静态成员数据&quot;">​</a></h3><p>static修饰的静态成员 属于类而不是对象。（所有对象 共享 一份 静态成员数据）</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB7.png" alt=""></p><p>static修饰的成员 定义类的时候 必须分配空间。</p><p>static修饰的静态成员数据 必须类中定义 类外初始化。</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">#include</span><span style="color:#ADBAC7;"> </span><span style="color:#96D0FF;">&lt;iostream&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F47067;">using</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">namespace</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">std</span><span style="color:#ADBAC7;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F47067;">class</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">Data</span></span>
...
<span class="line"><span style="color:#24292E;">    </span><span style="color:#D73A49;">return</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">0</span><span style="color:#24292E;">;</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h2 id="_15-类的存储结构" tabindex="-1">15. 类的存储结构 <a class="header-anchor" href="#_15-类的存储结构" aria-label="Permalink to &quot;15. 类的存储结构&quot;">​</a></h2><p>成员函数、静态成员 不占类的空间。</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB8.png" alt=""></p><p>成员函数、静态成员 是独立存储 是所有对象共享</p><h2 id="_16-this指针" tabindex="-1">16.this指针 <a class="header-anchor" href="#_16-this指针" aria-label="Permalink to &quot;16.this指针&quot;">​</a></h2><h3 id="_1、知识点的引入" tabindex="-1">1、知识点的引入 <a class="header-anchor" href="#_1、知识点的引入" aria-label="Permalink to &quot;1、知识点的引入&quot;">​</a></h3><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB9.png" alt=""></p><h3 id="_2、普通成员函数-默认有一个this指针-指向调用该成员函数的对象" tabindex="-1">2、普通成员函数 默认有一个this指针 指向调用该成员函数的对象 <a class="header-anchor" href="#_2、普通成员函数-默认有一个this指针-指向调用该成员函数的对象" aria-label="Permalink to &quot;2、普通成员函数 默认有一个this指针 指向调用该成员函数的对象&quot;">​</a></h3><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">class</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">Data2</span></span>
<span class="line"><span style="color:#ADBAC7;">{</span></span>
<span class="line"><span style="color:#F47067;">public:</span></span>
...
<span class="line"><span style="color:#24292e;">102 bob 99</span></span></code></pre></div><p>如果使用全局函数 重载运算符 必须将全局函数设置成友元。</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB12.png" alt=""></p><h3 id="_3、可以重载的运算符" tabindex="-1">3、可以重载的运算符 <a class="header-anchor" href="#_3、可以重载的运算符" aria-label="Permalink to &quot;3、可以重载的运算符&quot;">​</a></h3><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB11.png" alt=""></p><h2 id="_20-强化string类" tabindex="-1">20. 强化string类 <a class="header-anchor" href="#_20-强化string类" aria-label="Permalink to &quot;20. 强化string类&quot;">​</a></h2><h3 id="mystring-h" tabindex="-1">Mystring.h <a class="header-anchor" href="#mystring-h" aria-label="Permalink to &quot;Mystring.h&quot;">​</a></h3><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">#ifndef</span><span style="color:#ADBAC7;"> </span><span style="color:#DCBDFB;">MYSTRING_H</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">    </span><span style="color:#D73A49;">return</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">false</span><span style="color:#24292E;">;</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h2 id="_21-重载函数调用运算符" tabindex="-1">21. 重载函数调用运算符() <a class="header-anchor" href="#_21-重载函数调用运算符" aria-label="Permalink to &quot;21. 重载函数调用运算符()&quot;">​</a></h2><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%B1%BB13.png" alt=""></p><h2 id="_22-智能指针" tabindex="-1">22. 智能指针 <a class="header-anchor" href="#_22-智能指针" aria-label="Permalink to &quot;22. 智能指针&quot;">​</a></h2><p>智能指针：解决 堆区空间的对象 释放问题</p><p>重载* 运算符：</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">#include</span><span style="color:#ADBAC7;"> </span><span style="color:#96D0FF;">&lt;iostream&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F47067;">using</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">namespace</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">std</span><span style="color:#ADBAC7;">;</span></span>
<span class="line"><span style="color:#F47067;">class</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">Data</span></span>
<span class="line"><span style="color:#ADBAC7;">{</span></span>
...
<span class="line"><span style="color:#005CC5;">5</span><span style="color:#24292E;"> };</span></span></code></pre></div><p>继承方式：private protected public(推荐)</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%BB%A7%E6%89%BF2.png" alt=""></p><p>公共继承 保持不变，保护继承变保护，私有继承变私有，所有父类私有在子类中不可见</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">#include</span><span style="color:#ADBAC7;"> </span><span style="color:#96D0FF;">&lt;iostream&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F47067;">using</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">namespace</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">std</span><span style="color:#ADBAC7;">;</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">};</span></span>
<span class="line"><span style="color:#D73A49;">class</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Son</span><span style="color:#24292E;">:</span><span style="color:#D73A49;">public</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">Base</span></span></code></pre></div><h2 id="_25-子类的构造析够顺序" tabindex="-1">25. 子类的构造析够顺序 <a class="header-anchor" href="#_25-子类的构造析够顺序" aria-label="Permalink to &quot;25. 子类的构造析够顺序&quot;">​</a></h2><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%BB%A7%E6%89%BF3.png" alt=""></p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#F47067;">#include</span><span style="color:#ADBAC7;"> </span><span style="color:#96D0FF;">&lt;iostream&gt;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F47067;">using</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">namespace</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">std</span><span style="color:#ADBAC7;">;</span></span>
<span class="line"><span style="color:#F47067;">class</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">Base</span></span>
<span class="line"><span style="color:#ADBAC7;">{</span></span>
...
<span class="line"><span style="color:#24292e;">20</span></span></code></pre></div><h2 id="_30-菱形继承" tabindex="-1">30. 菱形继承 <a class="header-anchor" href="#_30-菱形继承" aria-label="Permalink to &quot;30. 菱形继承&quot;">​</a></h2><p>菱形继承：有公共祖先的继承 叫菱形继承。</p><p>最底层的子类 数据 会包含多分（公共祖先的数据）</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E7%BB%A7%E6%89%BF4.png" alt=""></p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#6CB6FF;">1</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">class</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">Animal</span></span>
<span class="line"><span style="color:#ADBAC7;">2 {</span></span>
<span class="line"><span style="color:#6CB6FF;">3</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">public:</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h3 id="_2、分析虚继承的实现原理" tabindex="-1">2、分析虚继承的实现原理 <a class="header-anchor" href="#_2、分析虚继承的实现原理" aria-label="Permalink to &quot;2、分析虚继承的实现原理&quot;">​</a></h3><p>虚继承 会在子类中产生 虚基类指针（vbptr） 指向 虚基类表(vbtable), 虚基类表纪录的是通过该指针访问公共祖先的数据的偏移量。</p><p>注意：虚继承只能解决具备公共祖先的多继承所带来的二义性问题，不能解决没有公共祖先的多继承的.</p><p>工程开发中真正意义上的多继承是几乎不被使用，因为多重继承带来的代码复杂性远多于其带来的便利，多重继承对代码维护性上的影响是灾难性的，在设计方法上，任何多继承都可以用单继承代替。</p><h2 id="_32-多态的概述" tabindex="-1">32.多态的概述 <a class="header-anchor" href="#_32-多态的概述" aria-label="Permalink to &quot;32.多态的概述&quot;">​</a></h2><p>静态多态（编译时多态，早绑定）：函数重载、运算符重载</p><p>动态多态（运行时多态，晚绑定）：虚函数</p><h2 id="_33-虚函数" tabindex="-1">33. 虚函数 <a class="header-anchor" href="#_33-虚函数" aria-label="Permalink to &quot;33. 虚函数&quot;">​</a></h2><h3 id="_1、知识点引入" tabindex="-1">1、知识点引入 <a class="header-anchor" href="#_1、知识点引入" aria-label="Permalink to &quot;1、知识点引入&quot;">​</a></h3><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E5%A4%9A%E6%80%811.png" alt=""></p><p>父类指针（引用）保存 子类空间地址的目的 就是让算法通用。</p><h3 id="_2、父类指针-保存-子类空间地址-带来的问题" tabindex="-1">2、父类指针 保存 子类空间地址（带来的问题） <a class="header-anchor" href="#_2、父类指针-保存-子类空间地址-带来的问题" aria-label="Permalink to &quot;2、父类指针 保存 子类空间地址（带来的问题）&quot;">​</a></h3><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#6CB6FF;">1</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">class</span><span style="color:#ADBAC7;"> </span><span style="color:#F69D50;">Animal</span></span>
<span class="line"><span style="color:#ADBAC7;">2 {</span></span>
<span class="line"><span style="color:#6CB6FF;">3</span><span style="color:#ADBAC7;"> </span><span style="color:#F47067;">public:</span></span>
...
<span class="line"><span style="color:#24292e;">猫在喵喵</span></span></code></pre></div><h3 id="_4、虚函数原理" tabindex="-1">4、虚函数原理 <a class="header-anchor" href="#_4、虚函数原理" aria-label="Permalink to &quot;4、虚函数原理&quot;">​</a></h3><p>如果一个类中的成员函数 被virtual修饰，那么这个函数就是虚函数。类就会产生一个虚函数指针（vfptr）指向了一张虚函数表（vftable）。 如果这个类 没有涉及到继承， 这时虚函数表中 纪录及时当前类的虚函数入口地址。</p><p><img src="https://cdn.jsdelivr.net/gh/clint-sfy/blogcdn@master/img/c_plus/%E5%A4%9A%E6%80%813.png" alt=""></p><h2 id="_34-纯虚函数" tabindex="-1">34. 纯虚函数 <a class="header-anchor" href="#_34-纯虚函数" aria-label="Permalink to &quot;34. 纯虚函数&quot;">​</a></h2><p>虚函数不实现函数体：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">1 class Animal</span></span>
<span class="line"><span style="color:#adbac7;">2 {</span></span>
