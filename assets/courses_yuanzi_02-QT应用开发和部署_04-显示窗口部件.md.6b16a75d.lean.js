import{_ as t}from"./chunks/ArticleMetadata.efdb5e9a.js";import{_ as c,v as l,b as r,t as y,O as i,F as p,L as A,R as C,M as D,C as B,B as F}from"./chunks/framework.5cbdba25.js";import"./chunks/md5.02486a14.js";const S=JSON.parse('{"title":"显示窗口部件","description":"","frontmatter":{"title":"显示窗口部件","author":"阿源","date":"2023/08/04 12:00","categories":["QT快速入门"],"tags":["C++","QT5"]},"headers":[],"relativePath":"courses/yuanzi/02-QT应用开发和部署/04-显示窗口部件.md","filePath":"courses/yuanzi/02-QT应用开发和部署/04-显示窗口部件.md","lastUpdated":1695461708000}'),d={name:"courses/yuanzi/02-QT应用开发和部署/04-显示窗口部件.md"},E=p("h1",{id:"正点原子qt之显示窗口部件",tabindex:"-1"},[A("正点原子QT之显示窗口部件 "),p("a",{class:"header-anchor",href:"#正点原子qt之显示窗口部件","aria-label":'Permalink to "正点原子QT之显示窗口部件"'},"​")],-1),u=C(`<h2 id="_6-显示窗口部件" tabindex="-1">6 显示窗口部件 <a class="header-anchor" href="#_6-显示窗口部件" aria-label="Permalink to &quot;6 显示窗口部件&quot;">​</a></h2><h3 id="概述-10个" tabindex="-1">概述 （10个） <a class="header-anchor" href="#概述-10个" aria-label="Permalink to &quot;概述 （10个）&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">（1） Label:标签</span></span>
