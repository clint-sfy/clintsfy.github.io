...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#6CB6FF;--shiki-light-font-weight:bold;--shiki-dark-font-weight:bold;">## Initialization</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#ADBAC7;">作为角色 &lt;Role&gt;, 使用默认 &lt;language&gt; 与用户对话，友好的欢迎用户。然后介绍自己，并告诉用户&lt;Workflow&gt;。</span></span></code></pre></div>`,12);function E(s,f,m,F,w,B){const t=h,e=k("ClientOnly");return n(),r("div",null,[D,o(e,null,{default:d(()=>{var i,a;return[(((i=s.$frontmatter)==null?void 0:i.aside)??!0)&&(((a=s.$frontmatter)==null?void 0:a.showArticleMetadata)??!0)?(n(),y(t,{key:0,article:s.$frontmatter},null,8,["article"])):C("",!0)]}),_:1}),u])}const v=p(A,[["render",E]]);export{T as __pageData,v as default};
