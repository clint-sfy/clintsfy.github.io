import{_ as t}from"./chunks/ArticleMetadata.e10718d6.js";import{_ as c,v as l,b as r,E as y,O as i,F as p,L as B,R as A,M as C,C as D,B as d}from"./chunks/framework.2aeb816e.js";import"./chunks/md5.772bbdf1.js";const W=JSON.parse('{"title":"按钮","description":"","frontmatter":{"title":"按钮","author":"阿源","date":"2023/08/02 12:00","categories":["QT快速入门"],"tags":["C++","QT5"]},"headers":[],"relativePath":"courses/yuanzi/03-QT应用开发和部署/02-按钮.md","filePath":"courses/yuanzi/03-QT应用开发和部署/02-按钮.md","lastUpdated":1691327334000}'),u={name:"courses/yuanzi/03-QT应用开发和部署/02-按钮.md"},F=p("h1",{id:"正点原子qt之按钮",tabindex:"-1"},[B("正点原子QT之按钮 "),p("a",{class:"header-anchor",href:"#正点原子qt之按钮","aria-label":'Permalink to "正点原子QT之按钮"'},"​")],-1),h=A(`<h2 id="_4-按钮" tabindex="-1">4. 按钮 <a class="header-anchor" href="#_4-按钮" aria-label="Permalink to &quot;4. 按钮&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">（1） QPushButton:下压按钮</span></span>
