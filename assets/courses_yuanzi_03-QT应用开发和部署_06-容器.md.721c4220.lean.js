import{_ as t}from"./chunks/ArticleMetadata.59a467b2.js";import{_ as c,v as l,b as r,t as y,O as i,F as p,L as A,R as C,M as D,C as B,B as d}from"./chunks/framework.5cbdba25.js";import"./chunks/md5.02486a14.js";const L=JSON.parse('{"title":"容器","description":"","frontmatter":{"title":"容器","author":"阿源","date":"2023/08/06 12:00","categories":["QT快速入门"],"tags":["C++","QT5"]},"headers":[],"relativePath":"courses/yuanzi/03-QT应用开发和部署/06-容器.md","filePath":"courses/yuanzi/03-QT应用开发和部署/06-容器.md","lastUpdated":1691327334000}'),F={name:"courses/yuanzi/03-QT应用开发和部署/06-容器.md"},u=p("h1",{id:"正点原子qt之容器",tabindex:"-1"},[A("正点原子QT之容器 "),p("a",{class:"header-anchor",href:"#正点原子qt之容器","aria-label":'Permalink to "正点原子QT之容器"'},"​")],-1),g=C(`<h2 id="_8-容器" tabindex="-1">8. 容器 <a class="header-anchor" href="#_8-容器" aria-label="Permalink to &quot;8. 容器&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">（1） Group Box:组框</span></span>
...
<span class="line"><span style="color:#6F42C1;">MainWindow</span><span style="color:#24292E;">::</span><span style="color:#D73A49;">~</span><span style="color:#6F42C1;">MainWindow</span><span style="color:#24292E;">()</span></span>
<span class="line"><span style="color:#24292E;">{</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,42);function E(s,h,W,b,Q,q){const o=t,e=D("ClientOnly");return l(),r("div",null,[u,y(e,null,{default:i(()=>{var n,a;return[(((n=s.$frontmatter)==null?void 0:n.aside)??!0)&&(((a=s.$frontmatter)==null?void 0:a.showArticleMetadata)??!0)?(l(),B(o,{key:0,article:s.$frontmatter},null,8,["article"])):d("",!0)]}),_:1}),g])}const k=c(F,[["render",E]]);export{L as __pageData,k as default};
